...
class StudentLogin extends React.Component{
  ...
  signupForm(e){
    ...
    .then((user)=>{
      ...
      fire.database().ref('tors/'+user.user.uid).set({teacher:false}).then(()=>{
        console.log('Student Registration With Password Successful!')
      })
  ...
  facebookLogin(){
    ...
    fire.auth().signInWithPopup(provider).then((result)=>{
      ...
      fire.database().ref('tors/'+result.user.uid).set({teacher:false}).then(()=>{
        console.log('Student Login With Facebook Successful!')
      })
    }).catch((err)=>{
  ...
  googleLogin(){
    ...
    fire.auth().signInWithPopup(provider).then((result)=>{
      ...
      fire.database().ref('tors/'+result.user.uid).set({teacher:false}).then(()=>{
        console.log('Student Login With Google Successful!')
      })
    }).catch((err)=>{
      console.log(err.email+''+err.credential+''+err.message)
    })
